...
double printer_toolhead_axis_maximum[4] = {280, 280, 0, 0};
    ...
    if (bed_mesh["profiles"] != nlohmann::detail::value_t::null) {
        if (bed_mesh["profiles"]["default"] != nlohmann::detail::value_t::null) {
            if (bed_mesh["profiles"]["default"]["points"] != nlohmann::detail::value_t::null) {
                printer_bed_mesh_profiles_mks_points[0][0] = bed_mesh["profiles"]["default"]["points"][0][0];
                printer_bed_mesh_profiles_mks_points[0][1] = bed_mesh["profiles"]["default"]["points"][0][1];
                printer_bed_mesh_profiles_mks_points[0][2] = bed_mesh["profiles"]["default"]["points"][0][2];
                printer_bed_mesh_profiles_mks_points[0][3] = bed_mesh["profiles"]["default"]["points"][0][3];
                printer_bed_mesh_profiles_mks_points[1][0] = bed_mesh["profiles"]["default"]["points"][1][0];
                printer_bed_mesh_profiles_mks_points[1][1] = bed_mesh["profiles"]["default"]["points"][1][1];
                printer_bed_mesh_profiles_mks_points[1][2] = bed_mesh["profiles"]["default"]["points"][1][2];
                printer_bed_mesh_profiles_mks_points[1][3] = bed_mesh["profiles"]["default"]["points"][1][3];
                printer_bed_mesh_profiles_mks_points[2][0] = bed_mesh["profiles"]["default"]["points"][2][0];
                printer_bed_mesh_profiles_mks_points[2][1] = bed_mesh["profiles"]["default"]["points"][2][1];
                printer_bed_mesh_profiles_mks_points[2][2] = bed_mesh["profiles"]["default"]["points"][2][2];
                printer_bed_mesh_profiles_mks_points[2][3] = bed_mesh["profiles"]["default"]["points"][2][3];
                printer_bed_mesh_profiles_mks_points[3][0] = bed_mesh["profiles"]["default"]["points"][3][0];
                printer_bed_mesh_profiles_mks_points[3][1] = bed_mesh["profiles"]["default"]["points"][3][1];
                printer_bed_mesh_profiles_mks_points[3][2] = bed_mesh["profiles"]["default"]["points"][3][2];
                printer_bed_mesh_profiles_mks_points[3][3] = bed_mesh["profiles"]["default"]["points"][3][3];
                /*
